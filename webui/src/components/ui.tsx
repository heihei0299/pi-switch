...
const BTN: Record<BtnVariant, string> = {
  primary: "bg-indigo-600 hover:bg-indigo-500 text-white border-indigo-500 shadow-md shadow-indigo-600/20",
  ...
  return (
    <button
      ...
      className={cx(
        ...
        "shadow-sm transition-all active:scale-[0.98] disabled:opacity-40 disabled:cursor-not-allowed disabled:active:scale-100",
...
export function Card({
  ...
  return (
    <div style={style} className={cx("rounded-xl border border-white/10 bg-zinc-900/60 p-4 shadow-sm backdrop-blur", className)}>
      {children}
    </div>
  );
}
