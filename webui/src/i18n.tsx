...
const zh: Record<string, string> = {
  ...
  models: "个模型",
  "Create a new profile to get started.": "新建一个供应商开始使用。",
  Edit: "编辑",
  Test: "测试",
  "Test OK": "测试通过",
  Copy: "复制",
  ...
  // Gateway / Model rich editor (cc-switch parity)
  Gateway: "网关",
  "Gateway preview — confirm to apply": "网关预览 — 确认以应用",
  "Left shows diff, right is editable JSON. Conflicts highlighted.": "左侧显示差异，右侧为可编辑 JSON。高亮冲突项。",
  "Current vs Proposed": "当前 vs 提议",
  "No changes": "无变更",
  "Conflicts: hand-written fields will be overwritten": "冲突：手写字段将被覆盖",
  "proposed json": "提议 JSON",
  "Confirm": "确认",
  "Model config": "模型配置",
  "Model ID": "模型 ID",
  "Display name": "显示名称",
  "Support reasoning": "支持扩展思考",
  "Support image input": "支持图片输入",
  "Thinking levels": "思考档位",
  "Config JSON": "配置 JSON",
  "Fetch models": "获取模型列表",
  "Add model": "添加模型",
  "Configure available models and display names": "配置可用的模型及其显示名称",
  "No models configured": "暂无模型配置",
  "Copied": "已复制",
  "Request headers": "请求头",
  "随供应商请求发送的可选 HTTP 请求头，如 HTTP-Referer 或 X-Title。": "随供应商请求发送的可选 HTTP 请求头，如 HTTP-Referer 或 X-Title。",
  "No custom headers": "暂无自定义请求头",
  "Add header": "添加请求头",
  "Header 名称": "Header 名称",
  "Compatibility": "接口兼容性",
  "调整兼容端点或本地服务的请求行为。": "调整兼容端点或本地服务的请求行为。",
  "No compatibility options": "暂无兼容性选项",
  "Add": "添加",
  "Off": "关闭",
  "Default": "默认",
  "Unsupported": "不可用",
  "No models": "暂无模型",
  "注入到 ./pi/agent/models.json 的 provider 配置": "注入到 ./pi/agent/models.json 的 provider 配置",
  "结构化": "结构化",
  "模型配置（可展开编辑）": "模型配置（可展开编辑）",
};
